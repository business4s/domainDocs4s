...
const config: Config = {
  title: 'DomainDocs4S',
  tagline: 'Generate domain documentation from Scala code',
  ...
  themeConfig: {
    ...
    navbar: {
      title: 'DomainDocs4s',
      logo: {
        alt: 'DomainDocs4s Logo',
        src: 'img/domaindocs4s-logo.png',
      },
      items: [
        {
          type: 'docSidebar',
        ...
        {
          href: 'https://github.com/business4s/domaindocs4s',
          label: 'GitHub',
          position: 'right',
        },
        {
  ...
  customFields: {
    domaindocs4sVersion: process.env.DOMAINDOCS4S_VERSION,
  },
};
